        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left">
                ...
                <tbody>
                            ...
                            <tr class="border-b border-outline hover:bg-surface-container-low transition-colors">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex flex-wrap gap-2">
                                        <form method="POST" action="/admin/booking_status" class="inline">
                                            <input type="hidden" name="id" value="<?= htmlspecialchars($booking['id']) ?>">
                                            <input type="hidden" name="status" value="confirmed">
                                            <button type="submit" class="inline-flex items-center px-3 py-2 rounded-xl bg-primary text-white text-sm font-medium hover:bg-blue-700 transition">Xác nhận</button>
                                        </form>
                                        <form method="POST" action="/admin/booking_status" class="inline">
                                            <input type="hidden" name="id" value="<?= htmlspecialchars($booking['id']) ?>">
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="8" class="px-6 py-12 text-center text-on-surface-variant">Hiện không có đơn đặt tour nào.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
